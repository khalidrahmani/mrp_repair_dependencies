...
class ordervehicule(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context=None):
        super(ordervehicule, self).__init__(cr, uid, name, context=context)        
...
report_sxw.report_sxw('report.sale.ordervehicule', 'sale.order', 'addons/sale/report/sale_ordervehicule.rml', parser=ordervehicule, header="external")
